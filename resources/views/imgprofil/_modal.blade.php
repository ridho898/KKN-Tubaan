<div class="modal fade" tabindex="-1" role="dialog" id="modal-form">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="{{ url('imgprofil') }}" method="post" id="form-add-imgprofil" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-md-offset-4">
                        <img id="preview-img" src="{{ asset('images/imgprofil.png') }}" alt="foto" width="200px" height="200px">
