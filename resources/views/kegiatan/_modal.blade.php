<div class="modal fade" tabindex="-1" role="dialog" id="modal-form">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="{{ url('kegiatan') }}" method="post" id="form-add-kegiatan" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-md-offset-4">
                        <img id="preview-img" src="{{ asset('images/kegiatan.png') }}" alt="foto" width="200px" height="200px">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tanggal" id="tanggal" placeholder="24-10-15" required>
                </div>
                <div class="form-group">
                    <label for="nama">Waktu<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="waktu" id="waktu" placeholder=" 7:00 PM to 9:00 PM" required>
                </div>
                <div class="form-group">
                    <label for="nama">Tempat<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="tempat" id="tempat" placeholder="Kelurahan Mesjid RT. 20" required>
                </div>               
