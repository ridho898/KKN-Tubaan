          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <a id="btn-add" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus"></i> Tambah kegiatan</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
...
<script>
    $(function () {
        ...
        $('#btn-add').click(function () {
            ...
            $('#tempat').val('')            
            $('#img').val('')
            $('#preview-img').attr('src', '/images/kegiatan.png');
            $('#form-add-kegiatan').attr('action', targetUrl);
        ...
        $("#form-add-kegiatan").on('submit', function(e) {
            e.preventDefault();
            var form = $(this);
            ...
            $.ajax({
                type: "POST",
                url: url,
                data: new FormData($("#form-add-kegiatan")[0]),
                dataType:'JSON',
                contentType:false,
                processData:false,
...
<script>
    $('body').on('click','.btn-edit',function(){
        ...
        $('#tempat').val('')
        $('#img').val('')          
        $('#form-add-kegiatan').attr('action', targetUrl+'/'+id);
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                          $('#tabel-kegiatan').DataTable().ajax.reload();
                            swal("Poof! Data kegiatan Berhasil dihapus", {
                                icon: "success",
                            });
